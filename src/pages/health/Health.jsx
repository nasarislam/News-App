...
function Health() {
  ...
  function fetchApi(){
    fetch("https://newsapi.org/v2/top-headlines?country=in&apiKey=2b6c9f87e92248a09e4aef7b37fbb327&category=health&pageSize=30").then((res)=>res.json()).then((res)=>setApi(res.articles))
  }

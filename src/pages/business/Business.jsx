...
function Business() {
  ...
  function fetchApi() {
    fetch("https://newsapi.org/v2/top-headlines?country=in&apiKey=2b6c9f87e92248a09e4aef7b37fbb327&category=business&pageSize=50").then((res)=>res.json()).then((res)=>setApi(res.articles))
  }
